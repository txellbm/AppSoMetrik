...
Extrae los detalles de cada entrenamiento, incluyendo nombre, distancia y calorías, para rellenar la lista 'workouts'. Si los datos no están disponibles, proporciona una estimación razonable o una lista vacía.
